...
## Results (from this ROS 2 system)

The following plots are generated by running this repository (30 islands, GA) with different migration topologies.

![GA 30 islands FULL](assets/results/ga_30_full.png)
![GA 30 islands RING](assets/results/ga_30_ring.png)

## Visual intuition (illustrative animations)

The following animations are **conceptual visualisations** created to build intuition about optimiser dynamics.
They are **not generated from this ROS 2 system’s runtime data**.

- **DE**: worm-like motion — some particles remain nearly stationary while others stay active (exploration bursts).
- **PSO**: flock-like motion — a smooth, coordinated drift resembling a bird swarm.
- **GA**: cloud-like motion — a population that contracts/expands as selection and variation compete.

![DE intuition](assets/gifs/de_3d.gif)
![PSO intuition](assets/gifs/pso_3d.gif)
![GA intuition](assets/gifs/ga_3d.gif)
